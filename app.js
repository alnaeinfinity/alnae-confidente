  ...
  <div class="page" id="page-auth">
    ...
    <div class="card">
      ...
      <div class="rgpd-box">
        ...
        Vos données sont utilisées pour vérifier votre commande et vous envoyer la confirmation. Elles ne sont pas revendues. Conformément au RGPD : <strong>alnae.infinity@gmail.com</strong>
...
(() => {
  ...
  const CONFIG = {
    ...
    alnaEmail: 'alnae.infinity@gmail.com',
